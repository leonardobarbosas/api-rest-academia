package br.com.fiap.api_academia.security;
        ...
        return httpSecurity
                ...
                .authorizeHttpRequests(auth ->
                        auth
                                ...
                                .requestMatchers(HttpMethod.DELETE, "/academia/**").hasRole("ADMIN")
                                .requestMatchers(HttpMethod.DELETE, "/aluno/**").hasRole("ADMIN")
                                .requestMatchers(HttpMethod.PUT, "/academia/**").hasRole("ADMIN")
